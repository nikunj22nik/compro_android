...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>showmoreless</b> with <b>com.github.nonzero:ShowMoreLess</b> coordinates and
     * with version reference <b>showmoreless</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getShowmoreless() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("showmoreless");
    }

    /**
     * Dependency provider for <b>showmoretext</b> with <b>com.github.mahimrocky:ShowMoreText</b> coordinates and
     * with version reference <b>showmoretext</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getShowmoretext() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("showmoretext");
    }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>showmoreless</b> with value <b>1.0.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getShowmoreless() { return getVersion("showmoreless"); }

        /**
         * Version alias <b>showmoretext</b> with value <b>1.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getShowmoretext() { return getVersion("showmoretext"); }
    ...
    public static class HiltVersionAccessors extends VersionFactory  {
        ...
        private final HiltVersionVersionAccessors vaccForHiltVersionVersionAccessors = new HiltVersionVersionAccessors(providers, config);
        public HiltVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Group of versions at <b>versions.hilt.version</b>
         */
        public HiltVersionVersionAccessors getVersion() {
            return vaccForHiltVersionVersionAccessors;
        }

    }

    public static class HiltVersionVersionAccessors extends VersionFactory  {
         ...
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNum() { return getVersion("hilt.version.num"); }
    ...
    public static class HiltPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>hilt.version.num</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
